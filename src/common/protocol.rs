...
pub enum ProtocolRequest {
    ...
    //PostSlateRejection { from: String, to: String, slate_id: String, signature: String },
...
impl Display for ProtocolRequest {
    fn fmt(&self, f: &mut Formatter) -> Result {
        match *self {
            ...
            //ProtocolRequest::PostSlateRejection { ref from, ref to, slate_id: _, signature: _ } => write!(f, "{} from {} to {}", "PostSlateRejection".bright_purple(), from.bright_green(), to.bright_green()),
        }
    }
}
...
pub enum ProtocolResponse {
    ...
    //SlateRejection { from: String, slate_id: String, signature: String, challenge: String },
}
...
impl Display for ProtocolResponse {
    fn fmt(&self, f: &mut Formatter) -> Result {
        match *self {
            ...
            //ProtocolResponse::SlateRejection { ref from, slate_id: _, signature: _, challenge: _ } => write!(f, "{} from {}", "SlateRejection".cyan(), from.bright_green()),
        }
    }
}